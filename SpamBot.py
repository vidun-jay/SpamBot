...
print('* Enter how long the timer should be set for')
print(
    '* The chatbot requires a messenging app (Messenger, iMessage, Discord, etc.) to be open and the text already selected.'
...
while True:
    ...
    # If they select no exit the program. Why even open it in the first place >:(
    elif yn == 'n' or yn == 'N' or yn == "no" or yn == 'NO':
        exit()

    # In case the basic directions weren't clear
    else:
